    ...
    return (
      ...
      >
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-destructive">Silver Spread Unavailable</span>
      ...
      <div className={cn("p-4 bg-gradient-to-r", colors.gradient)}>
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs text-muted-foreground">Silver Arbitrage</h3>
            ...
            {hasShanghai ? (
              <>
                ...
                <p className="text-[10px] text-muted-foreground font-mono">
                  ¥{shanghai.priceCNY.toLocaleString()}
                </p>
              </>
            ) : (
